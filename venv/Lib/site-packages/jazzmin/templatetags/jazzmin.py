...
def get_side_menu(context: Context, using: str = "available_apps") -> List[Dict]:
    ...
    for app in available_apps:
        ...
        for model in app.get("models", []):
            ...
            model["countApp"] = Application.objects.count() 
            model["countAppForm"] = Application_Form.objects.count()
            model["countJob"] = Job.objects.filter(status = 'ACTIVE').count()
            model["countInter"] = Interview.objects.count()  
