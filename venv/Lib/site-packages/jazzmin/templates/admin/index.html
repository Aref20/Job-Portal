...
{% block bodyclass %}{{ block.super }} 'لوحة التحكم'{% endblock %}

{% block content_title %} {% trans 'لوحة التحكم' %} {% endblock %}

{% block breadcrumbs %}
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{% url 'admin:index' %}"><i class="fa fa-tachometer-alt"></i> {% trans 'Home' %}</a></li>
        <li class="breadcrumb-item">{% trans 'لوحة التحكم' %}</li>
    </ol>
{% endblock %}
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
              <div class="inner">
                <h3>{{dashboard_list.0.models.0.countApp}}</h3>
                <p>طلبات التوظيف </p>
              </div>
              <div class="icon">
                <i class="far fa-window-maximize"></i>
              </div>
              <a href={{dashboard_list.0.models.0.url}} class="small-box-footer"> مزيد من المعلومات  <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
              <div class="inner">
                <h3> {{dashboard_list.0.models.1.countAppForm}}</h3>
                <p>الطلبات العشوائية</p>
              </div>
              <div class="icon">
                <i class=" far fa-sticky-note"></i>
              </div>
              <a href={{dashboard_list.0.models.1.url}} class="small-box-footer"> مزيد من المعلومات  <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>{{dashboard_list.3.models.3.countJob}}</h3>
                <p>الوظائف النشطة </p>
              </div>
              <div class="icon">
                <i class="fas fa-briefcase"></i>
              </div>
              <a href={{dashboard_list.3.models.3.url}} class="small-box-footer"> مزيد من المعلومات <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>{{dashboard_list.2.models.0.countInter}}</h3>
                <p>المقابلات</p>
              </div>
              <div class="icon">
                <i class="fas fa-people-arrows"></i>
              </div>
              <a href={{dashboard_list.2.models.0.url}} class="small-box-footer"> مزيد من المعلومات  <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
        </div>
