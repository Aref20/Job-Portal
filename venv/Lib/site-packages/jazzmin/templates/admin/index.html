        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
              <div class="inner">
                <h3> {{dashboard_list.4.models.0.countAppForm}}</h3>
                <p> المستخدمون</p>
              </div>
              <div class="icon">
                <i class=" far fa-sticky-note"></i>
              </div>
              <a href={{dashboard_list.4.models.0.url}} class="small-box-footer"> مزيد من المعلومات  <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
