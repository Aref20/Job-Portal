        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>{{dashboard_list.2.models.3.countJob}}</h3>
                <p>الوظائف النشطة </p>
              </div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
              </div>
              <a href={{dashboard_list.2.models.3.url}} class="small-box-footer"> مزيد من المعلومات <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>{{dashboard_list.1.models.0.countInter}}</h3>
                <p>المقابلات</p>
              </div>
              <div class="icon">
                <i class="ion ion-pie-graph"></i>
              </div>
              <a href={{dashboard_list.1.models.0.url}} class="small-box-footer"> مزيد من المعلومات  <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
        </div>
