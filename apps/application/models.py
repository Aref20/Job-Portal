...
from apps.job.models import Language as Lang
...
class Application(models.Model):
    ...
    department =  models.ForeignKey(Group, on_delete=models.SET_NULL, null=True,blank=True,verbose_name=' القسم ')
    ...
    def __str__(self):
        return self.UserProfile_App.user.username