# Generated by Django 3.2.6 on 2022-11-01 16:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience_min', models.IntegerField(blank=True, null=True, verbose_name='الخبرة من')),
                ('experience_max', models.IntegerField(blank=True, null=True, verbose_name='الخبرة الى ')),
                ...
                ('required_competencies', models.TextField(max_length=3000, null=True, verbose_name='المهارات المطلوبة ')),
                ('other', models.TextField(blank=True, max_length=3000, null=True, verbose_name=' مهارات أخرى ')),
                ('Career_Level', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='job.career_level', verbose_name='مستوى الخبرة ')),
