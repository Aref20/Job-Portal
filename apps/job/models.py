...
class Job(models.Model):
    ...
    reason = models.TextField(max_length=3000,verbose_name=' السبب ',null=True)
...
>>>>>>> 6d1e5612c55e23af9fe877b39e477031198ffd69:job/models.py
    ...
    def job_actions(self):
        ...
        return format_html(' <a href="send/%d/" class="link"><i class="fas fa-solid fa-envelope"></i></a> ' %self.id)
    job_actions.short_description = 'طلب وظيفة '
...
class JobHistory(models.Model):
    job = models.ForeignKey(Job, on_delete=models.SET_NULL,related_name='JobHistory', null=True,verbose_name=' تاريخ الوظيفة ')
    open_date = models.DateField(auto_now_add=True,verbose_name=' تاريخ فتح الوظيفة',null=True,blank=True)
    close_date = models.DateField(auto_now_add=True,verbose_name=' تاريخ إغلاق الوظيفة',null=True,blank=True)
    vacancy = models.IntegerField(blank=True,verbose_name='الشواغر ',null=True)
    reason = models.TextField(max_length=3000,verbose_name=' السبب ',null=True)
    days = models.IntegerField(blank=True,verbose_name='عدد الايام ',null=True)

    class Meta:
        verbose_name = _(' تاريخ الوظيفة ')
        verbose_name_plural = _(' تاريخ الوظيفة ')
...
class Title(models.Model):
    ...
    description = models.TextField(max_length=20000,verbose_name='الوصف ')
    department = models.ForeignKey(Group,on_delete=models.SET_NULL, null=True,verbose_name=' القسم')
