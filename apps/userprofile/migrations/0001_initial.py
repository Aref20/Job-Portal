    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='profile_images/', verbose_name='الصورة الشخصية')),
                ...
                ('Phone_Num', models.IntegerField(null=True, verbose_name='الخلوي ')),
                ...
                ('Experience_Years', models.IntegerField(null=True, verbose_name='عدد سنوات الخبرة')),
                ...
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name=' ألإسم')),
            ],
            options={
