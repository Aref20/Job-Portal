...
class ProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        'Birth_Date': forms.DateInput(attrs={'class' :' date  form-control ','pattern':'[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])'}),
        ...
        'Available_Date': forms.DateInput(attrs={ 'class': ' date form-control','pattern':'[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])'}),
...
class UserForm(forms.ModelForm):
    ...
    class Meta:
        ...
        User = forms.CharField(disabled=True)
        widgets = {
            'first_name': forms.TextInput(attrs={'placeholder':' الاسم:  ', 'class': 'form-control'}),
...
class QualificationForm(forms.ModelForm):
        ...
        class Meta:
            ...
            fields = '__all__'
            widgets = {
                'Qualification_Profile': forms.TextInput(),
                ...
                'Graduation_Date': forms.DateInput(attrs={'placeholder':'تاريخ التخرج  ', 'class': 'date form-control','required': True,'pattern':'[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])'}),
...
class LanguageForm(forms.ModelForm):
        ...
        class Meta:
            ...
            fields = '__all__'
            widgets = {
                'Language_Profile': forms.TextInput(),
...
class Computer_SkillForm(forms.ModelForm):
        ...
        class Meta:
            ...
            fields = '__all__'
            widgets = {
                'Computer_Skill_Profile': forms.TextInput(),
...
class Previous_CompanyForm(forms.ModelForm):
        ...
        class Meta:
            ...
            fields = '__all__'
            #exclude = ('Previous_Company_Profile',)
            widgets = {
                'Previous_Company_Profile': forms.TextInput(),
                ...
                'Duration_From':forms.DateInput(attrs={'class': 'date form-control','required': True,'pattern':'[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])'}),
                'Duration_To': forms.DateInput(attrs={ 'class': 'date form-control','required': True,'pattern':'[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])'}),
...
class TrainingForm(forms.ModelForm):
        ...
        class Meta:
            ...
            fields = '__all__'
            widgets = {
                'Training_Profile': forms.TextInput(),
                'Name': forms.TextInput(attrs={'placeholder':' اسم الدورة التدريبية', 'class': 'form-control','required': True}),
                'Duration_From': forms.DateInput(attrs={'placeholder':' تاريخ بدء الدورة ', 'class': ' date form-control','required': True,'pattern':'[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])'}),
                'Duration_To': forms.DateInput(attrs={'placeholder':'  تاريخ إنتهاء الدورة', 'class': ' date form-control','required': True,'pattern':'[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])'}),
...
class Previous_CoworkerForm(forms.ModelForm):
        ...
        class Meta:
            ...
            fields = '__all__'
            widgets = {
                'Previous_Coworker_Profile': forms.TextInput(),
...
ProfileLanguageFormSet = inlineformset_factory(
     UserProfile, UserLanguage, form=LanguageForm,
      extra=1, can_delete=True
     )
