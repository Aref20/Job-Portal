...
class Interview(models.Model):
    ...
    hiring_Recommendation = models.CharField(choices=[('Pending', 'قيد الإنتظار'),('Yes', 'نعم'),('No', 'لا'),('Waiting', 'قائمة الإنتظار'),('Second_Interview', 'مقابلة ثانية '),('Black_List', ' القائمة السوداء ')],default='Pending',max_length=16,verbose_name='التوصية بالتعين')
    Second_Interview_Time = models.DateTimeField(blank=True,default=now ,verbose_name=' تحديد تاريخ المقابلة الثانية')
    ...
    def __str__(self):
<<<<<<< HEAD:apps/interview/models.py
        return self.interview_application.UserProfile_App.user.username
=======
        return self.interview_application.UserProfile_App.Name
>>>>>>> 6d1e5612c55e23af9fe877b39e477031198ffd69:interview/models.py
