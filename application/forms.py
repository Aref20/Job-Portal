...
class ApplicationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = '__all__'
        widgets = {
        'Application_NID': forms.NumberInput(attrs={'placeholder':'الرقم الوطني ', 'class': 'form-control'}),
        ...
        'Application_Car_License': forms.Select(attrs={'class':'form-select'}),
        'Application_Socility_Status': forms.Select(attrs={'class':' form-select'}),
        'Application_Have_Car': forms.Select(attrs={'class':'form-select'}),
       ...
       # 'Application_Q_Graduation_Date': forms.TextInput(attrs={'placeholder':' تاريخ التخرج', 'class': ' date form-control'}),
        'Application_L_Language': forms.TextInput(attrs={'class': 'form-control'}),
        'Application_L_Type_Conversation': forms.Select(attrs={'class': 'form-select'}),
        'Application_L_Type_Writing': forms.Select(attrs={ 'class': 'form-select'}),
        'Application_L_Type_Reading': forms.Select(attrs={ 'class': 'form-select'}),
        'Application_C_Computer_Skill': forms.TextInput(attrs={'class': 'form-control'}),
        'Application_C_Computer_Level': forms.Select(attrs={ 'class': 'form-select'}),
        ...
        'Application_Company_Prev_Duration_From':forms.DateInput(attrs={'class': 'date form-control'}),
        'Application_Company_Prev_Duration_To': forms.DateInput(attrs={ 'class': 'date form-control'}),
        ...
        'Application_Coworker_Ask': forms.Select(attrs={ 'class': 'form-select'}),
        ...
        'Application_Relative_Frinds': forms.Select(attrs={ 'class': 'form-select'}),
        'Application_Relative_Frinds_Job': forms.TextInput(attrs={ 'class': 'form-control'}),
        'Application_Diseases': forms.Select(attrs={ 'class': 'form-select'}),
