...
class ApplicationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        'Company_Prev_Phone': forms.NumberInput(attrs={'placeholder':' رقم الهاتف', 'class': 'form-control'}),
        ...
        'Company_Prev_Start_Salary': forms.NumberInput(attrs={'placeholder':' الراتب عند البداية', 'class': 'form-control'}),
        'Company_Prev_Last_Salary': forms.NumberInput(attrs={'placeholder':' الراتب عند النهاية', 'class': 'form-control'}),
        ...
        'Prev_Coworker_Phone': forms.NumberInput(attrs={ 'placeholder':' رقم  المعرف','class': 'form-control'}),
    ...
    class QualificationForm(forms.ModelForm):
        ...
        class Meta:
            ...
            fields = '__all__'
            widgets = {
                'Degree': forms.NumberInput(attrs={'placeholder':' المؤهل العلمي ', 'class': 'form-control'}),
                'University': forms.NumberInput(attrs={'placeholder':'اسم الجامعة/الكلية/المدرسة ', 'class': 'form-control'}),
                'Graduation_Date': forms.NumberInput(attrs={'placeholder':'تاريخ التخرج  ', 'class': 'form-control'}),
                'Major': forms.NumberInput(attrs={'placeholder':'التخصص  ', 'class': 'form-control'}),
