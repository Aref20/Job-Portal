# Generated by Django 3.2.6 on 2022-10-13 17:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('userprofile', '0003_alter_userprofile_experience_years'),
        ('job', '__first__'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Job_App', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='JA', to='job.job')),
                ('UserProfile_App', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='userprofile.userprofile')),
            ],
            options={
