...
class Application(models.Model):
    ...
    Application_Available_Date = models.DateField()
    ...
    Application_Company_Prev_Duration_From = models.DateField()
    Application_Company_Prev_Duration_To = models.DateField()
    ...
    Application_T_Training_Duration_From = models.DateField()
    Application_T_Training_Duration_To = models.DateField()
