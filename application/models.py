...
class Application(models.Model):
    UserProfile_App = models.ForeignKey(User, on_delete=models.CASCADE,null=True,blank =True)
    Job_App = models.ForeignKey(Job, on_delete=models.CASCADE,null=True,blank =True)
